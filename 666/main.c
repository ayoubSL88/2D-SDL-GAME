...
int main(int argc, char *argv[])
{
    ...
    while (!quit)
    {
        ...
        // Vérification de la collision entre le personnage et le bonus
        if (!bonus.collected)
        {
            if (collisionBonus(&player, &bonus))
            {
                collecterBonus(&player, &bonus);
